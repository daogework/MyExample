...
namespace 算法连接测试
{
    ...
    {
        public static string ip_port = "47.243.76.221:5505";
        static Channel? channel;
        static GrpcApi.GrpcApiClient? client;
        static void Main(string[] args)
        {
            ...
            static string ReelsToString(int[][]? Reels, string tab)
            {
            ...
            static string AllReelsToString(int[][][]? AllReels, int tabNumber = 1)
            {
                string tab = "";
            ...
            static string TwoDArrToString(int[][]? arr,string tab = "")
            {
